...
object PatientStage {
    ...
    fun canUseReminders(stageIndex: Int?): Boolean = canAccessPatientExerciseHub(stageIndex)

    fun usesExerciseHubAsHome(stageIndex: Int?): Boolean =
        canAccessPatientExerciseHub(stageIndex)
